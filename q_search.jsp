...
<html>
    ...
    <body>
        <table border="1" width="100%" align="center">
            ...
            <%@page import="java.io.*" %>
            <%! String p, m, f1, f2, j_id, email, f_name, l_name, q_id, skills, city, country;%>
               ...
               f2 = request.getParameter("f2");
                try {
                    ...
                    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/new?zeroDateTimeBehavior=CONVERT_TO_NULL", "root",
                             "");
                    PreparedStatement pstm = con.prepareStatement(" select * from seek_det where skills ='" + f1 + "' and city='"+f2+"' ");
