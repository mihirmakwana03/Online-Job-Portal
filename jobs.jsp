                    ...
                    try {
                        ...
                        if (!res.next()) {
                            ...
                            do {
                                ...
                                out.println("<tr><td>" + email + "</td><td>" + j_cat + "</td><td>" + no_vac + "</td><td>" + q_id + "</td><td>" + addr1 + ", " + city + ", " + country + "</td><td>" + skills + "</td><td><a href='jobs_apply.jsp?j_id=" + j_id + "&job_id=" + job_id + "'>Apply</a></td></tr>");
                            } while (res.next());
                        }
